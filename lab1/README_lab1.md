...
![Рисунок 2 — Ответ корневого маршрута](screenshots/root.png)
...
![Рисунок 3 — JSON-ответ `/api/status`](screenshots/status.png)
...
![Рисунок 4 — JSON-ответ `/api/info`](screenshots/info.png)
...
![Рисунок 5 — Ответ параметризованного эндпоинта](screenshots/user-5.png)
...
**Скриншот 6 — проверка параметризованного эндпоинта с другими значениями ID.**

![Рисунок 6 — Проверка параметров](screenshots/user-params.png)
...
![Рисунок 7 — Ответ 404](screenshots/404.png)
