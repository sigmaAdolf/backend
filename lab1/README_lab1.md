...
**Скриншот 6-7 — проверка параметризованного эндпоинта с другими значениями ID.**

![Рисунок 6 — Проверка параметров](screenshots/omg-6.png)
![Рисунок 7 — Проверка параметров](screenshots/img-5.png)
...
![Рисунок 8 — Логирование запросов](screenshots/logging.png)

## Выполнение индивидуального задания

> В этом разделе необходимо указать фактически выданный вариант. Номер варианта не указан в предоставленном задании, поэтому конкретные индивидуальные данные здесь не выдумываются.
