...
̵ 5 эндпоинтов (1 текстовый, 2 простых JSON-эндпоинта, 1 JSON-эндпоинт с параметром в пути, 1 обработчик 404).  
̵ Автоматический перезапуск.  
̵ Реализация простого консольного логирования всех входящих запросов (метод + URL + время).  
...
**Скриншот 16 — проверка текстового эндпоинта индивидуального задания.**

![Рисунок 16 — Первый индивидуальный эндпоинт](screenshots/img-16.png)

**Скриншот 17 — проверка второго эндпоинта индивидуального задания.**

![Рисунок 17 — Второй индивидуальный эндпоинт](screenshots/img-17.png)

**Скриншот 18 — проверка третьего эндпоинта индивидуального задания.**

![Рисунок 18 — Третий индивидуальный эндпоинт](screenshots/img-18.png)

**Скриншот 19 — проверка параметризованного эндпоинта.**

![Рисунок 19 — Четвертый индивидуальный эндпоинт](screenshots/img-19.png)

**Скриншот 20 — проверка обработчика 404.**

![Рисунок 20 — проверка обработчика 404](screenshots/img-20.png)

**Скриншот 21 — Логирование HTTP-запросов.**

![Рисунок 21 — Логирование HTTP-запросов](screenshots/img-21.png)
